...
class InvalidDataException(msg: String = "There's a problem with the values you're trying to insert or delete or the object's associations.") extends RuntimeException(msg)
