...
class FactoryExistsException(msg: String = "A factory with that name already exists.") extends RuntimeException(msg)
...
class InvalidDataException(msg: String = "There's a problem with the values you're trying to insert or delete or the object's associations. Possible cause: If you want to use CleanerHedgehog, all factories must have a delete method defined.") extends RuntimeException(msg)
